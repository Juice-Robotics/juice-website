    ...
    return <div className={(dark ? styles.dark : styles.light)}>
        ...
        <main className={styles.main}>
            ...
            <section>
                ...
                <MemberBlock side="LEFT" name="Hunter" title="Team Captain" headshot="\assets\team\hunty.png" description="Hunter is a junior at Folsom High. This year is his 4th year on Team Juice and in FTC. He looks forward to applying mechanical concepts and math to design intuitive components that will tackle this year's challenge. This is also his second year of being on the software team. Outside of robotics, he likes to play tennis and learn about rockets." />
                ...
                <MemberBlock side="LEFT" name="Siddharth" title="Lead Software Developer" headshot="\assets\team\sid2.jpg" description="Siddharth Ray is the Software Lead Developer on Juice and this is his fourth year being on Juice. He helps manage and develop the software that runs on our robot, as well as coding outreach projects and help manage financials. He attends Vista del Lago High School as a junior. Outside of Team Juice, Siddharth Ray is the founder and CEO of DJFlame, captain of the Vista Solar Car Racing Team, and is a film-maker." headshotOptions={{}} />
                <MemberBlock side="RIGHT" name="Anya" title="Outreach Lead" headshot="\assets\team\anya2.png" description="Anya is part of the hardware team on Team Juice. Currently, she is a junior attending Vista del Lago High School. In her free time, she enjoys singing, reading, and cooking. She loves public speaking and participates in Speech and Debate and in Model UN. She also loves to travel and hopes to visit 50 countries in her lifetime." />
                <MemberBlock side="LEFT" name="Aditya" title="Hardware Member" headshot="\assets\team\aditya.jpg" description="Aditya Rajeev is a 11th grader at Vista Del Lago High School. Aditya is a member of the hardware team on Team Juice. Reading and studying chemistry is one of the things he likes to do. He also enjoys performing in classical arts, like Indian vocal, Violin, and Drums. Participating in Math and Science tournaments is one of his deepest passions and allows him to focus in on the academic aspect." />
                <MemberBlock side="RIGHT" name="Shyam" title="Hardware Member" headshot="\assets\team\shyam.jpg" description="Shyam is a member of the hardware team on Juice and specializes in CAD. As a senior at Folsom High, this will be his fourth year competing in FTC. Each year, he looks forward to applying his skills to create innovative solutions to a new challenge. Outside of robotics, he enjoys playing the drums, snowboarding, and training for his private pilot license."/>
                <MemberBlock side="LEFT" name="Zhiming" title="Software Member" headshot="\assets\team\zhiming.png" description="Zhiming Qi is in her second year at Juice, where she is a member of the software programming team. She is looking forward to using her mathematical knowledge for practical use in robotics. Besides FTC, she enjoys competing in CyberPatriot tournaments, as well as playing tennis and performing violin. She is a sophomore at Folsom High School."/>

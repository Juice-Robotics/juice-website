    ...
    return <div className={(dark ? styles.dark : styles.light)}>
        ...
        <main className={styles.main}>
            ...
            <section>
                ...
                <MemberBlock side="RIGHT" name="Spandhana" title="Team Vice Captain" headshot="\assets\team\ana.jpg" description="Spandhana is on her second-year of Team Juice and is the Vice-Captain. Spandhana looks forward to designing a cool robot for every game and loves building the robot while actively fixing problems and iterating as the season goes on. Outside of robotics, Ana runs cross country and volunteers at the local Sacramento animal shelter. #INeedMoreJoos" />
                <MemberBlock side="LEFT" name="Siddharth" title="Lead Software Developer" headshot="\assets\team\best_jooser.jpg" description="Siddharth Ray is the Software Lead Developer on Juice and this is his second year being on Juice. He helps manage and develop the software that runs on our robot, as well as coding outreach projects and help manage financials. He attends Vista del Lago High School as a freshman. Outside of Team Juice, Siddharth Ray is the founder and CEO of DJFlame, captain of the Vista Eagles Solar Car Racing Team, and is a film-maker." headshotOptions={{}} />

    ...
    return <div className={(dark ? styles.dark : styles.light)}>
        ...
        <main className={styles.main}>
                    ...
                    <div className={styles.picColumn}>
                        <picture>
                            <source
                                ...
                                alt="Team Juice (2022)"
                            />
                            <img src={"/assets/team/team_2026.jpg"} alt="Team Juice (2022)"></img>
                        </picture>
                    </div>
                    <div>
                        <p className={styles.hText}>{copypasta.about}</p>
            ...
            <section>
                ...
                <MemberBlock side="LEFT" name="Hunter" title="Team Captain" headshot="\assets\team\hunty.png" description="Hunter is a senior at Folsom High. This year is his fifth year on Team Juice and in FTC. He looks forward to applying mechanical concepts and math to design intuitive components that will tackle this year's challenge. This is also his third year of being on the software team. Outside of robotics, he likes to play tennis and learn about rockets." />
                <MemberBlock side="RIGHT" name="Siddharth" title="Lead Software Developer" headshot="\assets\team\sid3.png" description="Siddharth Ray is the Software Lead Developer on Juice and this is his fifth year being on Juice. He helps manage and develop the software that runs on our robot, as well as coding outreach projects and help manage financials. He attends Vista del Lago High School as a senior. Outside of Team Juice, Siddharth Ray is the founder and CEO of DJFlame, captain of the Vista Solar Car Racing Team, and is a film-maker." headshotOptions={{}} />
                ...
                <MemberBlock side="RIGHT" name="Sriram" title="Software Member" headshot="\assets\team\sriram.jpg" description="Sriram is currently a junior attending Folsom High. This is his fifth year doing FTC and his first year on Juice. He is looking forward to applying his design and math concepts and skills into both the design and coding aspects of FTC. Outside of robotics Sriram is part of the Folsom High School Marching band and likes to read and play flute in his free time."/>
                <MemberBlock side="LEFT" name="Ravi" title="Hardware Member" headshot="\assets\team\ravi2.jpg" description="Ravi is a sophomore at folsom high school. This is his first year at juice and is currently on the hardware team. He likes playing pickleball in his spare time and playing tennis."/>
                <MemberBlock side="RIGHT" name="Fallon" title="Hardware Member" headshot="\assets\team\fallon.jpg" description="Fallon is starting her first year with team Juice on the hardware team.  She's excited to bring designs to life as she spends her free time in Folsom High school's Product Design and Manufacturing class.  She loves to weld as well as 3D print items for her friends in the Sunshine PE program.  She loves robotics, has competed in VEX, and is excited to try FTC."/>
                <MemberBlock side="LEFT" name="Sreenidhi" title="Outreach Member" headshot="\assets\team\sreenidhi.jpg" description="Sreenidhi Rajeev is currently a 9th grader at Vista Del Lago. She is  involved in outreach, where she helps market, share ideas and connect with others. Outside of that, she enjoys creative activities like drawing and dancing. She also participates in several extracurricular activities, including debate, which has helped her develop her communication and critical thinking skills. She enjoys trying new things and continuously learning from different experiences."/>
            </section>

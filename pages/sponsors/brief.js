    ...
    return <div className={(dark ? styles.dark : styles.light)}>
        ...
        <main className={styles.main}>
            ...
            <section className={styles.financials}>
                ...
                <h2 style={{ color: "#FF9626" }}>2022-23 Sponsors</h2>
                {/* <div className={styles.sponsors}>
            ...
            <section className={styles.contact}>
                ...
                <p>Email us at <a href="mailto:ftcteam16236@gmail.com">ftcteam16236@gmail.com</a> with your work email and we will get back to you as soon as we can!
                <br/><br/><span><span>All donations are tax deductible</span> since we are an official initiative under Silent Bot Deadly 501(c)(3) Non-Profit.</span></p>
            </section>
        </main>
        <Footer dark={dark} />
    </div>
